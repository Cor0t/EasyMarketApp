...
public class RecuperarDatosHelados {
    private final Gson gson = new Gson();
    private final OkHttpClient client = new OkHttpClient();

    public void cargarHeladosEnFirebase(int pagina) {
        // URL modificada para la categoría "Helados"
        String url = String.format(
                "https://www.lider.cl/supermercado/category/Helados?page=%d",
                pagina
        );
        ...
        for (int pagina = inicio; pagina <= fin; pagina++) {
            ...
            new Thread(() -> {
                try {
                    ...
                    cargarHeladosEnFirebase(paginaActual);
